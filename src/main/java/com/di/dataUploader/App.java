...
public class App {
	...
	static void saxParse(String file,  boolean methodDB) {
		...
		try {
			...
			saxHandler.methodDB = methodDB;
			if(methodDB){
				saxHandler.db.openCloseSession();
				saxHandler.db.cleanTables();
				saxHandler.db.makeTransaction();
			}
